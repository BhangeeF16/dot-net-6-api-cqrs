...
{
    public class RegisterUserPostCodeBasedScheduleCommand : IRequest<string>
    {
        ...
        public AddressRequestModel? Shipping { get; set; }
        ...
        public class Validator : AbstractValidator<RegisterUserPostCodeBasedScheduleCommand>
        {
            public Validator()
            {
                ...
                RuleFor(c => c.Shipping).SetValidator(new AddressRequestModel.Validator());
