...
public static class RequirementPolicyExtensions
{
    ...
    public static string PolicyName(this RolePermission rolePermission) 
        => new StringBuilder().AppendFormat("{0}{2}{1}{3}", PolicyPrefix, Separator, rolePermission.PermissionLevel.GetDescription(), rolePermission.Module.Name).ToString().ToUpperInvariant();
}
